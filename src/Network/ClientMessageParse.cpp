...
#include "ClientMessages/CharacterMoveMessage.h"
#include "ClientMessages/NewCharacterMessage.h"
...
void ClientMessageParse::ParseMessage(std::istream& msg)
{
	...
	case ClientMessageType::NewCharacter:
	{
		NewCharacterMessage ncMsg = NewCharacterMessage();
	...
	{
        CharacterMoveMessage cmMsg = CharacterMoveMessage();
